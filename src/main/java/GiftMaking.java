...
import java.util.*;
public class GiftMaking extends NewYearGift
{
	...
	public static void inputGift() throws Exception
	{
		...
		for(int sweet=0;sweet<noOfSweets;sweet++)
		{
		    ...
		    sweetsWeight[sweet]=weight;
		    sweetsPrice[sweet]=price;
		}	
		...
		for(int chocolate=0;chocolate<noOfChocolates;chocolate++)
		{
		    ...
		    chocolatesWeight[chocolate]=weight;
		    chocolatesPrice[chocolate]=price;
